  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-md rounded-2xl border border-border/60 bg-card/60 backdrop-blur-xl p-8 space-y-5">
        {error ? (
          <>
            <h1 className="font-display text-xl tracking-wide">Authorization failed</h1>
          ...
          <>
            ...
            <p className="text-sm text-muted-foreground">
              This lets {details.client?.name ?? "the client"} read and manage your closet, outfits,
              measurements and try-ons as you.
            </p>
